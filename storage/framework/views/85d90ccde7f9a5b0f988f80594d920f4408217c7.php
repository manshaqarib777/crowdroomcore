    ...
    <div class="page-content-event">
        ...
        <div class="card notch-clear rounded-0 gradient-dark mb-n5">
            ...
            <div class="card-body mx-0 px-0 mt-n4 mb-5">               
                <div class="card-slider owl-carousel owl-no-dots mb-0">
    
                    <div class="card card-style mx-0 mt-4 bg-20" style="background-image:url('<?php echo e($row->getBannerImageUrlAttribute('full')); ?>')" data-card-height="141">
                    ...
                    ?>
                        <div class="card-bottom pl-3 pb-2">
                            <h5 class="color-white">Ticket: <?php echo e($row->display_price); ?> | <?php echo e($location->name ?? ''); ?></h5>
                        </div>
                        <?php endif; ?> 
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Event/Views/frontend/layouts/details/banner.blade.php ENDPATH**/ ?>