    ...
    <div class="panel-body">
        ...
        <!--<div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Duration (in hour)")); ?></label>
                        <input type="text" name="duration" class="form-control" value="<?php echo e($row->duration); ?>" placeholder="<?php echo e(__("Example: 3")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label"><?php echo e(__("Event Start Time")); ?></label>
                        <input type="text" name="start_time" class="form-control" value="<?php echo e($row->start_time); ?>" placeholder="<?php echo e(__("Example: 19:00")); ?>">
                    </div>
                </div>
            </div>
        <?php endif; ?>
                ...
                <?php if(!empty($translation->faqs)): ?>
                    ...
                    <?php $__currentLoopData = $translation->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                <div class="col-md-5">
                                    <input type="text" name="faqs[<?php echo e($key); ?>][title]" class="form-control" value="<?php echo e($faq['title']); ?>" placeholder="<?php echo e(__('Eg: When and where does the Event end?')); ?>">
                                </div>
                                <div class="col-md-6">
        ...
        <?php if(is_default_lang()): ?>
            <div class="form-group">
                <label class="control-label"><?php echo e(__("Event Poster Image")); ?></label>
            ...
            <div class="form-group">
                <label class="control-label"><?php echo e(__("Picture Gallery")); ?></label>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Event/Views/admin/event/content.blade.php ENDPATH**/ ?>