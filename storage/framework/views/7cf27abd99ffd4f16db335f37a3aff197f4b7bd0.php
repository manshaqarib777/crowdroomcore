        ...
        <div class="user-profile">
            ...
            <ul>
                <?php if(!Auth::id()): ?>
                    ...
                    <li>
                        <a href="#register" data-toggle="modal" data-target="#register" class="signup"><?php echo e(__('Register')); ?></a>
                    </li>
                <?php else: ?>
                    <li>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Layout/parts/header.blade.php ENDPATH**/ ?>