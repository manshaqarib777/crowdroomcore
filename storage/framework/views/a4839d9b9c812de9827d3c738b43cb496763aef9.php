...
$menus = [
    ...
    'space_request'=>[
        'url'        => 'admin/module/contact/spaceRequest',
        'title'      => __('Event Space Requests'),
        'icon'       => 'icon ion ion-md-mail',
        'permission' => 'contact_manage',
        'position' => 1
    ],
    'home_request'=>[
        'url'        => 'admin/module/contact/homeRequest',
        'title'      => __('Apartment Requests'),
        'icon'       => 'icon ion ion-md-mail',
        'permission' => 'contact_manage',
        'position' => 2
    ],
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Layout/admin/parts/sidebar.blade.php ENDPATH**/ ?>