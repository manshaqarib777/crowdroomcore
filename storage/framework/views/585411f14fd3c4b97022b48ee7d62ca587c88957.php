        ...
        <?php if(is_default_lang()): ?>
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo e($row->bathroom); ?>" placeholder="<?php echo e(__("/full day or /5 hours or /half day etc")); ?>" name="bathroom" class="form-control">
                </div>
            </div>
            </div>
        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Space/Views/admin/space/pricing.blade.php ENDPATH**/ ?>