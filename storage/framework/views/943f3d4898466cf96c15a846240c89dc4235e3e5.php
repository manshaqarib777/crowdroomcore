...
<div class="item-loop <?php echo e($wrap_class ?? ''); ?>">
    ...
    <?php endif; ?>
        ...
        <?php if($row->max_guests): ?>
            <span class="amenity total" data-toggle="tooltip"  title="<?php echo e(__("No. People")); ?>">
               <?php echo e(__(':count Guest in maximum',['count'=>$row->max_guests])); ?> Capacity
            </span> 
            
        <!-- <?php echo e($row->bed); ?> <?php echo e(__("No. Bed")); ?>-->
    ...
    <div class="thumb-image ">
        <a <?php if(!empty($blank)): ?>  <?php endif; ?> href="<?php echo e($row->getDetailUrl($include_param ?? true)); ?>">
        ...
        <div class="price-wrapper">
            <div class="price">
                ...
                <span class="text-price"><?php echo e($row->display_price); ?> <span class="unit">/ <?php echo e($row->bathroom); ?></span></span>
            </div>
            <!-- --> 
    ...
    <div class="amenities">
        <?php if($row->max_guests): ?>
            <span class="amenity total" data-toggle="tooltip"  title="<?php echo e(__("No. People")); ?>">
                <i class="input-icon field-icon icofont-users-social  "></i> <?php echo e($row->max_guests); ?>

            </span>
        <?php endif; ?>
        <?php if($row->bed): ?>
            <span class="amenity bed" data-toggle="tooltip" title="<?php echo e(__("No. Bed")); ?>">
                <i class="input-icon field-icon icofont-dining-table"></i> <?php echo e($row->bed); ?>
        ...
        <?php if($row->square): ?>
            <span class="amenity size" data-toggle="tooltip" title="<?php echo e(__("Square")); ?>" >
                <i class="input-icon field-icon icofont-building-alt"></i> <?php echo size_unit_format($row->square); ?>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Space/Views/frontend/layouts/search/loop-gird.blade.php ENDPATH**/ ?>