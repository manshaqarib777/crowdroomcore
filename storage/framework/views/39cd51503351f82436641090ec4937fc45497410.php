    ...
    <div class="form-group">
        ...
        <div class="form-content">
            ...
            <div class="smart-search">
                <input type="text" class="smart-select parent_text form-control" readonly placeholder="<?php echo e(__("Category")); ?>" value="<?php echo e($cat_name); ?>" data-default="<?php echo e(json_encode($list_cat_json)); ?>">
                <input type="hidden" class="child_id" name="cat_id" value="<?php echo e(Request::query('cat_id')); ?>">
            </div>
        </div>
    </div>
</div><?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/frontend/layouts/search-map/fields/category.blade.php ENDPATH**/ ?>