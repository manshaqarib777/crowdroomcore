<div class="filter-item filter-simple dropdown">
    <div class="form-group dropdown-toggle" data-toggle="dropdown" >
        <span class="filter-title"><?php echo e(__('Price')); ?> <i class="fa fa-angle-down"></i></span>
    </div>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Car/Views/frontend/layouts/search-map/fields/price.blade.php ENDPATH**/ ?>