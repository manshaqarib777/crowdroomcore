<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="filter-div d-flex justify-content-between ">
            <div class="col-left">
                <?php if(!empty($rows)): ?>
                <form method="post" action="<?php echo e(url('admin/module/contact/spaceBulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
            ...
            <div class="col-left">
               <form method="get" action="<?php echo e(url('/admin/module/contact/spaceRequest')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->space_type_id); ?></td>
                                        <td><?php echo e($row->attendee_id); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/crowdroom.y3579.com/modules/Contact/Views/admin/space-request.blade.php ENDPATH**/ ?>