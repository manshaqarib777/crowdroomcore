<div class="<?php if(setting_item('event_enable_inbox')): ?> has-vendor-box <?php endif; ?>">
    <div class="bravo_single_book">
        <div id="bravo_event_book_app" v-cloak>
            ...
            <!--<div class="form-head">-->
            <!--    <div class="price" >-->
            <!--        <span class="label">The <?php echo e($translation->title); ?> Event</span>-->
            <!--    </div>-->
            <!--    </div>-->
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Event/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>