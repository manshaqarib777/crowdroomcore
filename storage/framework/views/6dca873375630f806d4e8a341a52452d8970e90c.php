...
<body class="frontend-page <?php echo e($body_class ?? ''); ?> <?php if(setting_item_with_lang('enable_rtl')): ?> is-rtl <?php endif; ?> <?php if(is_api()): ?> is_api <?php endif; ?>">
    ...
    <div class="bravo_wrap">
        ...
        <div id="bravo_content-wrapper">
            <?php echo $__env->make("Contact::frontend.blocks.contact.space-request", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/modules/Contact/Views/space-request.blade.php ENDPATH**/ ?>