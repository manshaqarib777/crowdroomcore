    ...
    <div class="gateways-table accordion" id="accordionExample">
        ...
        <?php $__currentLoopData = $gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(config('app.show_offline_payment_for_'.$service->type.'_only') && $k=='offline_payment'): ?>
                <div class="card">
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Booking/Views/frontend/booking/checkout-payment.blade.php ENDPATH**/ ?>