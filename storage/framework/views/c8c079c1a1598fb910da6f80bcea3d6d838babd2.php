            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('Places by')); ?> <a href="<?php echo e(__('https://www.crowdroom.net')); ?>" target="_blank"><?php echo e(__('CrowdRoom Inc')); ?></a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="<?php echo e(__('https://www.crowdroom.net')); ?>" target="_blank"><?php echo e(__('About Us')); ?></a>
                            <a href="<?php echo e(__('https://tawk.to/chat/5f7289cb4704467e89f30e10/default')); ?>" target="_blank"><?php echo e(__('Contact Us')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Layout/admin/app.blade.php ENDPATH**/ ?>