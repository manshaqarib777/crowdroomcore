<div class="panel">
    ...
    <div class="panel-body">
        ...
        <?php if(is_default_lang()): ?>
            <div class="form-group">
                <label class="control-label"><?php echo e(__("Experience Category")); ?></label>
                <div class="">
                    <select name="category_id" class="form-control">
                        <option value=""><?php echo e(__("-- What type of experience is this? --")); ?></option>
                        <?php
            ...
            <!-- <div class="form-group">
                <label class="control-label"><?php echo e(__("Youtube Video （*optional）")); ?></label>
            ...
            <div class="form-group">
                <label class="control-label"><?php echo e(__("Duration of Your Activity")); ?></label>

                <div class="input-group mb-3">
                    <input type="text" name="duration" class="form-control" value="<?php echo e($row->duration); ?>" placeholder="<?php echo e(__("Duration in hours")); ?>"  aria-describedby="basic-addon2">
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>