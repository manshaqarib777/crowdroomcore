<div class=" <?php if(setting_item('tour_enable_inbox')): ?> has-vendor-box <?php endif; ?>">
    <div class="bravo_single_book">
        <div id="bravo_tour_book_app" v-cloak>
         ...
         <a href="https://tawk.to/chat/5f7289cb4704467e89f30e10/default"><?php echo e(__("Enquiry")); ?></a>
                </div>
            ...
            <!--<div class="form-head">-->
            <!--    <div class="price" >-->
            <!--        <span class="label">Merchant will call you after booking </span>-->
            <!--    </div>-->
            <!--    </div>-->
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/frontend/layouts/details/tour-form-book.blade.php ENDPATH**/ ?>