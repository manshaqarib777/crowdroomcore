            ...
            <div class="form-group">
                ...
                <div class="form-content">
                    ...
                    <div class="smart-search">
                        ...
                        <input type="hidden" class="child_id" name="term_id" value="<?php echo e(Request::query('term_id')); ?>">
                    </div>
                </div>
            </div>
        </div>
    <?php endif; ?>
<?php endif; ?><?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Event/Views/frontend/layouts/search-map/fields/attr.blade.php ENDPATH**/ ?>