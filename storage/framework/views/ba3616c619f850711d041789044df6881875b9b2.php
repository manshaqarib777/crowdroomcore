...
<?php if(!empty($title)): ?>
    <div class="g-include-exclude">
        <h3> <?php echo e($title); ?> Package(s) </h3>
        <div class="row">
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/frontend/layouts/details/tour-include-exclude.blade.php ENDPATH**/ ?>