            ...
            <div class="container">
                ...
                <div class="right">
                    <?php if($row->getBookingEnquiryType() === "book"): ?>
                        <a class="btn btn-primary" href="<?php echo e(route('tour.detail.mobile',$slug)); ?>"><?php echo e(__("Book Now")); ?></a>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/frontend/detail.blade.php ENDPATH**/ ?>