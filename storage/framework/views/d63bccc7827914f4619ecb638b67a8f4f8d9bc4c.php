    ...
    <div class="container">
        ...
        <div class="right">
            <?php if($row->getBookingEnquiryType() === "book"): ?>
                <a class="btn btn-primary" href="<?php echo e(route('event.detail.mobile',$slug)); ?>"><?php echo e(__("Register Now")); ?></a>
            <?php else: ?>
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Event/Views/frontend/layouts/details/form-book-mobile.blade.php ENDPATH**/ ?>