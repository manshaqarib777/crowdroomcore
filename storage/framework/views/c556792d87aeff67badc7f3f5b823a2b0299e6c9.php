        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        <?php if(!empty($rows)): ?>
                            <form method="post" action="<?php echo e(url('admin/module/tour/attribute/editAttrBulk')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                    ...
                    <div class="col-left">
                        <form method="get" action="<?php echo e(url('/admin/module/tour/attribute')); ?> " class="filter-form filter-form-right d-flex justify-content-end" role="search">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/admin/attribute/index.blade.php ENDPATH**/ ?>