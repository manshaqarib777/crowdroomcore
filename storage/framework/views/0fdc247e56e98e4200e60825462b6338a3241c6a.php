<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" class="form-control" placeholder="<?php echo e(__("Real tour address")); ?>" value="<?php echo e($translation->address); ?>">
        </div>
        <?php if(is_default_lang()): ?>
            <div class="form-group">
...
</div><?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Tour/Views/admin/tour/tour-location.blade.php ENDPATH**/ ?>