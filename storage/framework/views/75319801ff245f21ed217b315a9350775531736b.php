...
<!--                        <span class="text-lg"><?php echo e($row->display_price); ?>/ Year</span>-->
<!--                    </span>-->
<!--                </div>-->
<!--            </div>-->
...
<!--            <div class="form-head">-->
<!--                <div class="price" >-->
<!--                    <span class="label"><?php echo e($translation->title); ?> </span>-->
<!--                </div>-->
<!--                </div>-->
            
<!--            <div class="nav-enquiry" v-if="is_form_enquiry_and_book">-->
<!--                <div class="enquiry-item active" >-->
<!--                    <span><?php echo e(__("Book House Visit")); ?></span>-->
<!--                </div>-->
                
                     
<!--                          <div class="enquiry-item">-->
<!--                    <a href="https://tawk.to/chat/5f7289cb4704467e89f30e10/default"-->
<!--                    target="popup" -->
<!--  onclick="window.open('https://tawk.to/chat/5f7289cb4704467e89f30e10/default','popup','width=600,height=600'); return false;"><?php echo e(__("Enquiry")); ?></a>-->
...
<!--            <div class="form-head">-->
<!--                <div class="price" >-->
<!--                    <span class="label">Choose A Day to see this house below</span>-->
<!--                </div>-->
<!--                </div>-->
...
<!--                    <p><i>-->
<!--                           After, We will call you directly to arrange meet time & place-->
...
<?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Car/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>