...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label><?php echo e(__("No. Bed")); ?></label> <!-- IMPORTANT INFO-->
                    <input type="text" value="<?php echo e($row->bed); ?>" placeholder="<?php echo e(__("Only open at Nights or Government Issued ID is required here")); ?>" name="bed" class="form-control">
                </div>
            </div>
            <!-- <div class="col-md-4">
                <div class="form-group">
                    <label><?php echo e(__("No. Bathroom")); ?></label>
                    <input type="text" value="<?php echo e($row->bathroom); ?>" placeholder="<?php echo e(__("Example: 5")); ?>" name="bathroom" class="form-control">
                </div>
            </div>-->
            <div class="col-md-4">
                <div class="form-group">
                    <label><?php echo e(__("Square")); ?></label>
                    <input type="text" value="<?php echo e($row->square); ?>" placeholder="<?php echo e(__("Example: 100")); ?>" name="square" class="form-control">
                </div>
            </div>
        </div>
    </div>
</div>
<?php endif; ?><?php /**PATH /www/wwwroot/crowdroom.y3579.com/custom/Space/Views/admin/space/content.blade.php ENDPATH**/ ?>