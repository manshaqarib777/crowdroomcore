        ...
        <div class="card notch-clear rounded-0 gradient-dark mb-n5">
            ...
            <div class="card-body mx-0 px-0 mt-n4 mb-5">               
                <div class="card-slider owl-carousel owl-no-dots mb-0">
                    ...
                    <div class="card card-style mx-0 mt-4 bg-20" style="background-image:url('{{$row->getBannerImageUrlAttribute('full')}}')" data-card-height="141">
                    ...
                    @endphp
                        <div class="card-bottom pl-3 pb-2">
                            <h5 class="color-white">Ticket: {{ $row->display_price }} | {{$location->name ?? ''}}</h5>
                        </div>
                        @endif 
