        ...
        <div class="ticket-content">
            <div class="ticket-header d-flex justify-content-between">
                <div class="service-info">
                    ...
                    <div class="servive-name">{{__('Ticket Number :# :number',['number'=>$booking->id])}} 
                    <br><span >{{__('Status')}}:</span> {{ $booking->status_name }} | Amount Paid: {{format_money($booking->paid)}}</div>
                </div>
                <div class="print">
            ...
            <div class="ticket-body">
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td><div class="label"><i class="fa fa-money"></i> {{__("Ticket Price")}}</div>
                    ...
                    <tr>
                        ...
                        <td><div class="label"><i class="fa fa-user"></i> {{__("Attendee / Guest")}}</div>
            ...
            <div class="ticket-footer">
                <div class="text-center">{{__("Show Ticket & QR Code at Checkin Counter")}}</div>
