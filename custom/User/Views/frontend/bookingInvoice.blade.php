...
@section('head')
    ...
    <div id="invoice-print-zone">
        <table width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <th width="50%" align="right" class="text-right">
                    <h2 class="invoice-text-title">{{__("VOUCHER")}}</h2>
        ...
        <div class="customer-info">
            ...
            <span>Name名：{{$booking->first_name.' '.$booking->last_name}}</span>
            <br>
            <br>
            <span>Email邮件ID:  {{$booking->email}}</span><br>
            <span>Phone电话:  {{$booking->phone}}</span><br>
