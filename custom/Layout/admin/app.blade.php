            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Places by')}} <a href="{{__('https://www.crowdroom.net')}}" target="_blank">{{__('CrowdRoom Inc')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://www.crowdroom.net')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://tawk.to/chat/5f7289cb4704467e89f30e10/default')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
