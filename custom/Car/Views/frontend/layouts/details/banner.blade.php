@if($row->banner_image_id)
    ...
    <div class="card-slider owl-carousel owl-no-dots mb-0" style="margin-top:-35px;">
                    ...
                    <div class="card card-style mx-0 mt-4 bg-20" style="background-image:url('{{$row->getBannerImageUrlAttribute('full')}}')" data-card-height="210">
                        <!--<div class="card-top pl-3 pt-3">-->
                        <!--    <h1 class="color-white font-19">MasterCard</h1>-->
                        <!--</div>-->
                        <div class="card-center pr-3">
                            <!--<h4 class="color-white text-right"> Rental Price : {{ $row->display_price }}</h4>-->
                        </div>
                    ...
                    @endphp
                        ...
                        <h5 class="color-white"> In {{$location->name ?? ''}}</h5>
                        </div>
                    ...
                    @endif 
                     ...
                     <div class="card card-style mx-0 mt-4 bg-20" style="background-image:url('{{$row->getImageUrlAttribute('full')}}')" data-card-height="210">
                        <!--<div class="card-top pl-3 pt-3">-->
                        <!--    <h1 class="color-white font-19">MasterCard</h1>-->
                        <!--</div>-->
                        <div class="card-center pr-3">
