<div class="panel">
    ...
    <div class="panel-body">
        ...
        @if(is_default_lang())
            <div class="form-group">
                <label class="control-label">{{__("Experience Category")}}</label>
                <div class="">
                    <select name="category_id" class="form-control">
                        <option value="">{{__("-- What type of experience is this? --")}}</option>
                        <?php
            ...
            <!-- <div class="form-group">
                <label class="control-label">{{__("Youtube Video （*optional）")}}</label>
            ...
            <div class="form-group">
                <label class="control-label">{{__("Duration of Your Activity")}}</label>

                <div class="input-group mb-3">
                    <input type="text" name="duration" class="form-control" value="{{$row->duration}}" placeholder="{{__("Duration in hours")}}"  aria-describedby="basic-addon2">
