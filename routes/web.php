...
|
*/
Route::get('/intro','LandingpageController@index')->middleware(['wechat_auth']);
Route::get('/', 'HomeController@index')->middleware(['wechat_auth']);
Route::get('/home', 'HomeController@index')->name('home')->middleware(['wechat_auth']);
...
Route::get('/wechatCallback','WechatCallbackController@index');
Route::get('/wechatauth/login','WechatAuthController@login');
Route::get('/wechatauth/createuser/{openid}','WechatAuthController@createUser');
