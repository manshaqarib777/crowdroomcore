...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    function dologin(Request $request)
    {
        ...
        if ($validator->fails()) {
            return $this->sendError(__("Your Password is incorrect"), ['errors' => $validator->errors()]);
        }
    ...
    public function doCheckout(Request $request)
    {
        ...
        if(!auth()->check())
        {
            ...
            if($response==false)
            {
                return $this->sendError(__("Your Password is incorrect"));
            }
        }
