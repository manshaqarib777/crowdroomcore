...
// Tour
Route::group(['prefix'=>config('tour.tour_route_prefix'),'middleware' => ['wechat_auth']],function(){
    ...
    Route::get('/{slug}/detail','\Modules\Tour\Controllers\TourController@detail_for_mobile')->name('tour.detail.mobile');// Detail page for mobile
});
