...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\LazyPayerCheckout\Controllers';
    protected $adminModuleNamespace = 'Plugins\LazyPayerCheckout\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/LazyPayerCheckout')->group(__DIR__ . '/Routes/admin.php');
    }
