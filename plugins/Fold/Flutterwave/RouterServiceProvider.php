...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\Flutterwave\Controllers';
    protected $adminModuleNamespace = 'Plugins\Flutterwave\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/Flutterwave')->group(__DIR__ . '/Routes/admin.php');
    }
