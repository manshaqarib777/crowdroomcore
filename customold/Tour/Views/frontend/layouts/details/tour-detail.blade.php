                ...
                <div class="qr-product-details row">
                    <div class="qr-details col-7">
                        <div class="">
                            ...
                            @<span class="qr-address">{{ $translation->address ?? '' }}</span>
                        ...
                        <div class="qr-price" style="color: #00001e !important; margin-top:0 !important;padding-top:0">
                            <span class="qr-yen-logo">¥</span>{{ explode('.',$row->sale_price)[0] }}<span class="qr-small-dec">/Person </span><span class="qr-box" style="text-decoration: line-through;color: #c03!important;">¥{{ explode('.',$row->price)[0] }}</span>
                            <!--<span class="qr-small-dec">.{{ explode('.',$row->sale_price)[1] }}</span> -->
                    ...
                    <div class="qr-code-img text-center col-5">
                        ...
                        <br>
                        <div class="qr-text">Long Press To Register For This
                         {{$translation->title}}
                        </div>
                    </div>
                </div>
