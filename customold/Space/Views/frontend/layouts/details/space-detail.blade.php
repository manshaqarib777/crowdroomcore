...
<div class="imp-infor">
    ...
    <div class="foot">
                ...
                <br>
                <div class="foot">
        <a href="https://tawk.to/chat/5f7289cb4704467e89f30e10/default">Click to Chat with us about this space在线聊天</a>
        </div>
            ...
            <div class="qr-product-details row">
                <div class="qr-details col-7">
                    ...
                    <div class="qr-price" style="color: #00001e !important; margin-top:0 !important;padding-top:0">
                        <span class="qr-yen-logo">¥</span>{{ explode('.',$row->sale_price)[0] }}<span class="qr-price-unit"><span class="unit">/ {{$row->bathroom}}</span></span> <span class="qr-box"
                            style="text-decoration: line-through;color: #c03!important;">¥{{ explode('.',$row->price)[0] }}</span>
             ...
             <div class="qr-imp-infor">
                ...
                <div class="qr-code-img text-center col-5">
                    ...
                    <br>
                    <div class="qr-text">长按二维码<br>Long Press To see This
                        {{$translation->title}}.
                    </div>
                </div>
            </div>
