<div class="">
    <div class="bravo_single_book">
        <div id="bravo_space_book_app" v-cloak>
            ...
            <div class="form-head">
                <div class="price">
                    ...
                    <span class="value">
                        ...
                        <span class="text-lg">{{ $row->display_price }}<span class="unit">/ {{$row->bathroom}}</span></span>
                    </span>
                </div>
            </div>
            ...
            <div class="form-head">
                <div class="price" >
                    <span class="label">{{$translation->title}} </span>
                </div>
                </div>
            ...
            <div class="nav-enquiry" v-if="is_form_enquiry_and_book">
                ...
                <div class="enquiry-item">
                    ...
                    target="popup" 
  onclick="window.open('https://tawk.to/chat/5f7289cb4704467e89f30e10/default','popup','width=600,height=600'); return false;">{{ __("Enquiry") }}</a>
       
                </div>
                
                <!--   <a href="https://tawk.to/chat/5f7289cb4704467e89f30e10/default">{{ __("Enquiry") }}</a>
             ...
             <div class="form-head">
                <div class="price" >
                    <span class="label">Book 1 Day Earlier 提前一天预订 </span>
                </div>
                </div>
